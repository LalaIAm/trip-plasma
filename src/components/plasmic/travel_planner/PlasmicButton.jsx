...
import sty from "./PlasmicButton.module.css"; // plasmic-import: WNfjecg9kIP/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: FCQRss-iDqk/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: HjxXNamACUz/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__nJaTt)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__upfJp)}
                role={"img"}
              />
            ),
