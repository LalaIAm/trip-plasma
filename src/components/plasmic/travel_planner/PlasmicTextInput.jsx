...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: 5hjPTTFEdUE/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: SfCwwY7368b/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: FCQRss-iDqk/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__ql9YY)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__gK1GX)}
                role={"img"}
              />
            ),
